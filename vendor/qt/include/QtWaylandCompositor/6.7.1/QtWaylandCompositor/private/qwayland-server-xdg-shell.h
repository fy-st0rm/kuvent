...
// source file is /build/qt6-wayland/src/qtwayland/src/compositor/../3rdparty/protocol/xdg-shell.xml
...
namespace QtWaylandServer {
    ...
    protected:
        ...
        virtual void xdg_positioner_set_reactive(Resource *resource);
        virtual void xdg_positioner_set_parent_size(Resource *resource, int32_t parent_width, int32_t parent_height);
        virtual void xdg_positioner_set_parent_configure(Resource *resource, uint32_t serial);
    ...
    private:
        ...
        static void handle_set_offset(
            ...
            int32_t x,
            int32_t y);
        static void handle_set_reactive(
            ::wl_client *client,
            struct wl_resource *resource);
        static void handle_set_parent_size(
            ::wl_client *client,
            struct wl_resource *resource,
            int32_t parent_width,
            int32_t parent_height);
        static void handle_set_parent_configure(
            ::wl_client *client,
            struct wl_resource *resource,
            uint32_t serial);
    ...
    public:
        ...
        void send_configure_bounds(int32_t width, int32_t height);
        void send_configure_bounds(struct ::wl_resource *resource, int32_t width, int32_t height);
        void send_wm_capabilities(const QByteArray &capabilities);
        void send_wm_capabilities(struct ::wl_resource *resource, const QByteArray &capabilities);
    ...
    public:
        ...
        void send_repositioned(struct ::wl_resource *resource, uint32_t token);
    ...
    protected:
        ...
        virtual void xdg_popup_reposition(Resource *resource, struct ::wl_resource *positioner, uint32_t token);
