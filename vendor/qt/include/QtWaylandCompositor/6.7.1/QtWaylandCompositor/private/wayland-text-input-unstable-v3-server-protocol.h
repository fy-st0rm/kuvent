...
struct zwp_text_input_v3_interface {
	 ...
	 * the new one. At most one instance of text input may be in
	 * enabled state per instance, Requests to enable the another text
	 * input when some text input is active must be ignored by
	 * compositor.
	 *
