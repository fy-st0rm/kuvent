...
void DashBoard::onAttach() {
    ...
    V_dash_layout->addWidget(splitter);
    // Create the vertical panel (left side)
    ...
    QVBoxLayout *left_layout = new QVBoxLayout(leftPanel);
		...
		left_layout->addWidget(profile_button, 0, Qt::AlignHCenter | Qt::AlignTop);
		...
		left_layout->addWidget(ongoing_button, 0, Qt::AlignHCenter | Qt::AlignTop);
		...
		left_layout->addWidget(upcoming_button, 0, Qt::AlignHCenter | Qt::AlignTop);
		...
		left_layout->addWidget(post_button, 0, Qt::AlignHCenter | Qt::AlignTop);
    ...
    splitter->setSizes(QList<int>() << 50 << 550);
